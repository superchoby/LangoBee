...
export interface SubjectInfoToDisplay {
  header: string
  content: JSX.Element[]
}
...
export interface KanjiSubject {
  ...
  kanjiContainedWithinThis: Array<{
    character: string
    meanings: string[]
  }>
...
interface JapaneseCounterVocab {
  ...
  objectsThisIsUsedToCount: Array<{
    singular: string
    plural: string
  }>
...
export interface JapaneseVocabularySubject {
  kanjiThatThisUses: Array<{ character: string, meanings: string[] }>
  meaningMnemonic: string
  readingMnemonic: string
  mainMeaningsToUse: string[]
  mainTextRepresentation: string
  ...
  acceptableResponsesButNotWhatLookingFor: Array<{
    response: string
    reason: string
  }>
