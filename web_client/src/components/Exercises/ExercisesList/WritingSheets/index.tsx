...
import { getKanji } from './GetKanjiStrokes'
import { useEffect, useRef, useState } from "react"
import { WritingSheetsCharacterChoices } from './WritingSheetsCharacterChoices'
import { initDiagram, getDomFromString, StrokeOrderDiagram } from './GetKanjiStrokes'
...
export const WritingSheets = ({}: ExerciseBaseProps) => {
    ...
    const [kanjiDiagramsCache, changeKanjiDiagramsCache] = useState<{ [char: string]: string}>({})
