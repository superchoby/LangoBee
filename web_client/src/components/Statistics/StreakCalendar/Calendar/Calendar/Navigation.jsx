...
export default function Navigation ({
  ...
  const currentlyViewingThisMonth = activeStartDate.getMonth() === (new Date()).getMonth()
    ...
    <div className={className}>
      ...
      {nextLabel !== null && (
        <button
          ...
          disabled={currentlyViewingThisMonth}
          style={{ visibility: currentlyViewingThisMonth ? 'hidden' : 'visible' }}
          onClick={onClickNext}
          type="button"
        >
          {nextLabel}
