...
login_methods = [
    ('standard', 'the usual email, password input'),
    ('google', 'used google oauth'),
    ('facebook', 'used facebook oauth')
]
...
class User(AbstractUser):
    ...
    login_method = models.CharField(choices=login_methods, max_length=max(len(choice[0]) for choice in login_methods), default='standard')
