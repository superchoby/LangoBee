...
class Review(models.Model):
    ...
    # user = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, related_name='reviews', to_field='uuid')
    user_uuid = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, related_name='reviews')
